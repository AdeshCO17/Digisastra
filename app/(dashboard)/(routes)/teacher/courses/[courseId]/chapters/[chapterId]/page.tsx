...
import { ChapterTiltleForm } from "./_components/chapter-title-form";
...
const ChapterIdPage = async({
    ...
    return ( 
        ...
        {!chapter.isPublished && (
            <Banner
            variant="warning"
            label="This chapter is unpublised. It will not be visible in the course" 
            />
        )}
        <div className="p-6">
            <div className=" flex items-center justify-between">
                <div className=" w-full">
                    ...
                    <div className=" flex items-center justify-between w-full">
                        ...
                        isPublised={chapter.isPublished}
